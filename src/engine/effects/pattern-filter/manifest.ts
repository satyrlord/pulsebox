...
export const PATTERN_FILTER_MANIFEST = defineEffectManifest({ id: "pattern-filter", name: "Pattern Filter", shortLabel: "PTRN", parameters, compact: ["cutoff", "resonance", "drive", "mix"], sections: [{ id: "filter", name: "Filter and cutoff pattern", parameters: ["cutoff", "resonance", "drive", "mix"] }], accent: ["#50A384", "#285243", "#7ED6B4", "#3F846B"] });
