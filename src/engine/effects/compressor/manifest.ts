...
export const COMPRESSOR_MANIFEST = defineEffectManifest({ id: "compressor", name: "Compressor", shortLabel: "COMP", parameters, compact: ["threshold", "ratio", "attack", "release"], sections: [{ id: "dynamics", name: "Dynamics", parameters: ["threshold", "ratio", "attack", "release", "makeup"] }], meters: [{ id: "gain-reduction", name: "Gain Reduction" }], accent: ["#4E8DB8", "#27475C", "#78B9E3", "#3D7194"] });
